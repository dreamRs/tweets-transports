...
fluidRow(
  column(
    ...
    make_chart(data = m_incidents, line = 1, y_axis_lab = "Nombre de tweets")
  ),
  column(
    width = 4,
...
fluidRow(
  column(
    ...
    make_chart(data = m_incidents, line = 4, y_axis_lab = "Nombre de tweets")
  ),
  column(
    width = 4,
...
fluidRow(
  column(
    ...
    make_chart(data = m_incidents, line = 7, y_axis_lab = "Nombre de tweets")
  ),
  column(
    width = 4,
...
fluidRow(
  column(
    ...
    make_chart(data = m_incidents, line = 10, y_axis_lab = "Nombre de tweets")
  ),
  column(
    width = 4,
...
fluidRow(
  column(
    ...
    make_chart(data = m_incidents, line = 13, y_axis_lab = "Nombre de tweets")
  ),
  column(
    width = 4,
...
fluidRow(
  column(
    ...
    make_chart(data = r_incidents, line = "RER_A", type = "rer", y_axis_lab = "Nombre de tweets")
  ),
  column(
    width = 4,
...
fluidRow(
  column(
    ...
    make_chart(data = r_incidents, line = "RERD_SNCF", type = "rer", y_axis_lab = "Nombre de tweets")
  ),
  column(
    width = 4,
...
fluidRow(
  column(
    ...
    make_chart(data = t_incidents, line = "LIGNEJ_SNCF", type = "transilien", y_axis_lab = "Nombre de tweets")
  ),
  column(
    width = 4,
...
fluidRow(
  column(
    ...
    make_chart(data = t_incidents, line = "LigneH_SNCF", type = "transilien", y_axis_lab = "Nombre de tweets")
  ),
  column(
    width = 4,
...
setorder(m_incidents_tot, lib, variable)
