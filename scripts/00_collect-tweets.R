...
# get tweets
tweets_lignes <- lapply(X = lignes_RATP, FUN = get_timeline, n = 3200)
...
tweets_rer <- lapply(X = lignes_rer, FUN = get_timeline, n = 3200)
...
tweets_transilien <- lapply(X = transilien, FUN = get_timeline, n = 3200)
