...
rmd_group_buttons(
  ...
  arrange_button("Numéro de ligne", "ligneNum", TRUE),
  arrange_button("Total incidents (croissant)", "totalIncidents", icon = icon("sort-numeric-asc"), numeric = TRUE),
  arrange_button(label = "Total incidents (décroissant)", "totalIncidents", icon = icon("sort-numeric-desc"), numeric = TRUE, desc = TRUE)
)
```
...
rmd_group_buttons(
  ...
  arrange_button("Numéro de ligne", "ligneNum"),
  arrange_button("Total incidents (croissant)", "totalIncidents", icon = icon("sort-numeric-asc"), numeric = TRUE),
  arrange_button(label = "Total incidents (décroissant)", "totalIncidents", icon = icon("sort-numeric-desc"), numeric = TRUE, desc = TRUE)
)
```
